...
+(CCAnimation*) animationWithFile:(NSString*)name frameCount:(int)frameCount delay:(float)delay
{
	...
	//Depreciated ! return [CCAnimation animationWithName:name delay:delay frames:frames]; 
...
+(CCAnimation*) animationWithFrame:(NSString*)frame frameCount:(int)frameCount delay:(float)delay
{
	...
	// Depreciated ! return [CCAnimation animationWithName:frame delay:delay frames:frames];
    return [[[CCAnimation alloc] initWithFrames:frames delay:delay] autorelease];
